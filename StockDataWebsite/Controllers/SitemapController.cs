...
//using Microsoft.EntityFrameworkCore; // your namespace

//namespace StockDataWebsite.Controllers
//{
//    [ApiController] // Optional but recommended for API controllers
//    [Route("/")] // Base route can be root if handling specific paths
...
//                    new XElement("loc", "https://alphastockdata.com/sitemap-home.xml"),
...
//                sitemapIndex.Add(
//                    new XElement("sitemap",
//                        new XElement("loc", $"https://alphastockdata.com/sitemap-stocks-{i}.xml"),
//                        new XElement("lastmod", DateTime.UtcNow.ToString("yyyy-MM-dd"))
//                    )
//                );
//            }
...
//                new XElement("lastmod", DateTime.UtcNow.ToString("yyyy-MM-dd")),
//                new XElement("changefreq", freq),
//                new XElement("priority", priority.ToString("0.0"))
//            );
//        }
//    }
//}
